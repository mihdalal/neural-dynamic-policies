...
from ndp.pytorch_a2c_ppo_acktr_gail.a2c_ppo_acktr.utils import AddBias, init
...
class DiagGaussian(nn.Module):
    def __init__(self, num_inputs, num_outputs, scale=1, goal_network=False):
    ...
    def forward(self, x, inputs=None):
        ...
        return FixedNormal(self.scale*action_mean, action_logstd.exp())
